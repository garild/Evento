...
namespace Evento.Infrastructure.Repositories
{
    public class EventRepository : IEventRepository
    {
        ...
        {
            new Event(Guid.NewGuid(),"Event","Przykładowy opis",DateTime.UtcNow,DateTime.UtcNow.AddDays(5)),
             new Event(Guid.NewGuid(),"Event2","Przykładowy opis2",DateTime.UtcNow.AddHours(2),DateTime.UtcNow.AddDays(5)),
